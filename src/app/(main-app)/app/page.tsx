        ...
        <div className=" ">
            <div className="flex flex-col gap-1 mx-auto justify-center max-w-[600px] my-4 ">
                ...
                <div className="flex gap-2 justify-end mt-2">
                    <div className="flex gap-1 items-center border border-black w-max p-1  shadow-[4px_4px_#5eead4] rounded-2xl">
                    ...
                    <div className="flex gap-1 items-center border border-black w-max p-1  shadow-[4px_4px_#fda4af] rounded-2xl">
                        <div className="flex items-center">
                            <IconTicket size={18} />
                            Post
                        </div>
                    ...
                    <div className="flex gap-1 items-center border border-black w-max p-1  shadow-[4px_4px_#c4b5fd] rounded-2xl">
                        <div className="flex items-center">
                            <IconBulb size={18} />
                            Event
                        </div>
